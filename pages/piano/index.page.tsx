...
export default function PianoPage()
{
    ...
    useEffect(() => 
    {
        ...
        document.addEventListener("resize", GraphicManager.handleWindowResize.bind(GraphicManager))
        ...
        return () =>
        {
            ...
            document.removeEventListener("resize", GraphicManager.handleWindowResize.bind(GraphicManager))
        }
    }, [])
